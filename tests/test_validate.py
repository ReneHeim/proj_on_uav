...
class TestValidateExtractOutput:
    def test_clean_data_passes(self):
        ...
        df = pl.DataFrame({
            "Xw": [1.0, 2.0], "Yw": [1.0, 2.0],
            "band1": [0.1, 0.2], "band2": [0.2, 0.3], "band3": [0.3, 0.4],
            "band4": [0.4, 0.5], "band5": [0.5, 0.6],
            "elev": [100.0, 101.0],
            "delta_z": [50.0, 51.0], "delta_x": [1.0, 2.0], "delta_y": [1.0, 2.0],
            "distance_xy": [1.4, 2.8], "angle_rad": [0.5, 0.6],
            "vza": [30.0, 45.0], "vaa_rad": [1.0, 2.0], "vaa_temp": [1.0, 2.0],
            "vaa": [90.0, 180.0], "xcam": [0.0, 0.0], "ycam": [0.0, 0.0],
            "sunelev": [40.0, 40.0], "saa": [180.0, 180.0],
            "path": ["/a.tif", "/b.tif"],
        })
    ...
    def test_missing_required_columns_fails(self):
        ...
        df = pl.DataFrame({
            "Xw": [1.0], "Yw": [1.0], "band1": [0.1], "band2": [0.2],
            "band3": [0.3], "band4": [0.4], "band5": [0.5],
            "elev": [100.0], "delta_z": [50.0], "delta_x": [1.0], "delta_y": [1.0],
            "distance_xy": [1.0], "angle_rad": [0.5],
            "vza": [30.0], "vaa_rad": [1.0], "vaa_temp": [1.0],
            "vaa": [90.0], "xcam": [0.0], "ycam": [0.0],
            "sunelev": [40.0], "saa": [180.0],
            # missing "path"
        })
        with tempfile.TemporaryDirectory() as d:
            out = Path(d)
    ...
    def test_vza_out_of_range_fails(self):
        ...
        df = pl.DataFrame({
            "Xw": [1.0], "Yw": [1.0],
            "band1": [0.1], "band2": [0.2], "band3": [0.3],
            "band4": [0.4], "band5": [0.5],
            "elev": [100.0],
            "delta_z": [50.0], "delta_x": [1.0], "delta_y": [1.0],
            "distance_xy": [1.0], "angle_rad": [0.5],
            "vza": [110.0], "vaa_rad": [1.0], "vaa_temp": [1.0],
            "vaa": [90.0], "xcam": [0.0], "ycam": [0.0],
            "sunelev": [40.0], "saa": [180.0],
            "path": ["/a.tif"],
        })
