...
class TestANOVAPreprocess:
    ...
    def test_bin_labels_correct(self):
        ...
        assert result["vza_bin"].to_list() == [
            "0_to_20", "20_to_40", "40_to_60", "60_to_80", "60_to_80",
        ]
        assert result["raa_bin"].to_list() == [
            "-360_to_-270", "-270_to_-180", "-90_to_0", "90_to_180", "180_to_270",
        ]
...
class TestANOVAOptimized:
    ...
    def test_returns_expected_columns(self):
        ...
        result = ANOVA_optimized(df, "val", col="grp")
        expected_cols = {
            "group1", "group2", "mean group 2 - group1",
            "CI+-", "p_text", "-log10_p", "cohens_d", "reject",
            "F_global", "degrees of freedom", "eta_sq",
        }
