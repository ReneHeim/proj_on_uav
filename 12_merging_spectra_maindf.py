...
out = r"D:\on_uav_data\out_merged"
input_dir=r"D:\on_uav_data\out_filtered"
...
for radius in os.listdir(input_dir):
    ...
    for date in os.listdir(path_to_input_radius):
        ...
        for resolution in os.listdir(path_to_input_date):
            ...
            path_list = glob.glob(path_to_input_resolution + '\*.feather')
            dfs = list()
            ...
            df.to_csv(os.path.join(path_to_output_resolution,'on_uav_for_classification.csv'))
            
            df=df.reset_index().drop('index', axis=1)
            df.to_feather(os.path.join(path_to_output_resolution,'on_uav_for_classification.feather'))
