...
OUTPUT_ROOT = ROOT / "outputs/current_severity_curve_only_smooth_basis_2024_to_2025"
...
def setup_logging() -> Path:
    ...
    log_path = LOGS_DIR / f"analyze_current_severity_curve_only_smooth_basis_2024_to_2025_{timestamp}.log"
    logging.basicConfig(
        level=logging.INFO,
