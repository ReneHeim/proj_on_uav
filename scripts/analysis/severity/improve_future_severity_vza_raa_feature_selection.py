...
OUTPUT_ROOT = ROOT / "outputs/future_severity_vza_raa_feature_selection_improvement"
...
DIST_RESULTS_DIR = ROOT / "outputs/multiangular_distribution_feature_family/results"
RAA_2024 = (
    ROOT
