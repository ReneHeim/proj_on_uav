...
OUTPUT_ROOT = ROOT / "outputs/runs/analysis/severity/current/multiangular_plus_nadir_2024_to_2025"
...
CONTEXT_RESULTS = (
    ROOT / "outputs/runs/analysis/severity/current/2024_to_2025/results/current_severity_model_comparison.csv"
)
