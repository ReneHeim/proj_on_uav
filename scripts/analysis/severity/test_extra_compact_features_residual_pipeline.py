...
from scripts.analysis.severity.analyze_multiangular_distribution_feature_family import STABILITY_MIN_FREQUENCY  # noqa: E402
...
- `outputs/multiangular_distribution_feature_family/model_bottleneck_debug/results/exploratory_extra_compact_feature_acceptance.csv`
- `outputs/multiangular_distribution_feature_family/model_bottleneck_debug/results/exploratory_extra_compact_feature_acceptance_summary.csv`
- `outputs/multiangular_distribution_feature_family/model_bottleneck_debug/results/exploratory_extra_compact_forced_topk_results.csv`
