...
input_dir=[r"D:\on_uav_data\out\20200906_Bot", r"D:\on_uav_data\out\20200907_Bot"]
out = r"D:\on_uav_data\out_filtered"
...
for radius_id,radius in {'50cm_radius':0.5, '1m_radius':1, '2m_radius':2}.items():
    ...
    for directory in input_dir:
        ...
        for each_pixel_size in data_pixel_size:
            csv_list = glob.glob(os.path.join(directory,each_pixel_size)+r'\*.feather')
            ...
            for number, csv in tqdm(enumerate(csv_list), desc='loop 1'):
                ...
                result.to_feather(os.path.join(path_to_output_resolution,file_name))
