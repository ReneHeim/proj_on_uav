...
from oncerco_uav.core.preprocess import df_preprocess
from oncerco_uav.extract.raster import plotting_raster
from oncerco_uav.modelling.rpv import rpv_fit
from oncerco_uav.stats.Logistic_regression import (
    OLS,
...
def process_stats(dg, path, week, out):
    ...
    try:
        ...
        # === Plot distributions ===
        from oncerco_uav.stats.plotting import angle_kde_plot
        ...
        # Do ANOVA
        from oncerco_uav.stats.ANOVA import ANOVA_optimized, ANOVA_preprocess
...
def process_logistic_regression(out, week, gdf, debug=False):
    ...
    for healthy_df, diseased_df in couples:
        ...
        from oncerco_uav.stats.Logistic_regression import logistic_regression
