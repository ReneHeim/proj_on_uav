...
from oncerco_uav.core.search import optimized_recursive_search, order_path_list
from oncerco_uav.modelling.processing import process_weekly_data_rpv
from oncerco_uav.modelling.rpv import *
from oncerco_uav.stats.processing import process_weekly_data_stats
...
def main():
    ...
    parser.add_argument(
        "--base-dir", type=str, default=None, help="Search base directory (defaults to config base_path)"
    )
    ...
    objective = "plot_"
    base_dir = args.base_dir or config.base_path
