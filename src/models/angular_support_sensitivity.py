...
def write_report(summary, paired, skipped, total_time):
    ...
    lines.extend(
        [
            ...
            "## Outputs",
            "",
            "- Fold results: `outputs/results/angular_support_sensitivity_by_fold.csv`",
            "- Summary: `outputs/results/angular_support_sensitivity_summary.csv`",
            "- Paired effect: `outputs/results/angular_support_paired_effect.csv`",
            "- Figure: `outputs/figures/angular_support_sensitivity_auroc.png`",
            "",
            "## Reproducibility",
            "",
