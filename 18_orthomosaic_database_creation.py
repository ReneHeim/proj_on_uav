...
sources = [{'ortho_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_10cm\20200906_bot_corn_comb_10cm_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_10cm\20200906_bot_corn_comb_10cm_dem.tif", 
           'out': r"\20200906_Bot\20200906_bot_corn_comb_10cm\on_uav_for_classification_mosaic.csv"}, 
           
           {'ortho_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_50cm\20200906_bot_corn_comb_50cm_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_50cm\20200906_bot_corn_comb_50cm_dem.tif", 
           'out': r"\20200906_Bot\20200906_bot_corn_comb_50cm\on_uav_for_classification_mosaic.csv"}, 
           
           {'ortho_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_1m\20200906_bot_corn_comb_1m_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200906_Bot\agisoft\20200906_bot_corn_comb_1m\20200906_bot_corn_comb_1m_dem.tif", 
           'out': r"\20200906_Bot\20200906_bot_corn_comb_1m\on_uav_for_classification_mosaic.csv"},
           
           {'ortho_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_10cm\20200907_bot_corn_comb_10cm_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_10cm\20200907_bot_corn_comb_10cm_dem.tif", 
           'out': r"\20200907_Bot\20200907_bot_corn_comb_10cm\on_uav_for_classification_mosaic.csv"},
           
           {'ortho_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_50cm\20200907_bot_corn_comb_50cm_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_50cm\20200907_bot_corn_comb_50cm_dem.tif", 
           'out': r"\20200907_Bot\20200907_bot_corn_comb_50cm\on_uav_for_classification_mosaic.csv"},
           
           {'ortho_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_1m\20200907_bot_corn_comb_1m_mosaic.tif",
           'dem_path': r"D:\on_uav_data\20200907_Bot\agisoft\20200907_bot_corn_comb_1m\20200907_bot_corn_comb_1m_dem.tif", 
           'out': r"\20200907_Bot\20200907_bot_corn_comb_1m\on_uav_for_classification_mosaic.csv"}]
...
def process_orthomosaic(source):
    ...
    end6 = timer()
    plots = pd.read_csv(r"D:\on_uav_data\ground truth\gpscoords_plots_bottelare_raw.csv", names=['id', 'x', 'y'])
    ...
    for radius_id,radius in tqdm({'50cm_radius':0.5, '1m_radius':1, '2m_radius':2}.items()):
        path_to_save = f'D:\\on_uav_data\\out_merged\\{radius_id}'
        df = df_merged
        ...
        df_main = pd.read_csv(r"D:\on_uav_data\ground truth\07_after_dualex_finaldf.csv")
        df_main["lai_cat_a"] = pd.qcut(df_main['lai'], 3, labels=["low", "medium", "high"])
        df_main["lai_cat_b"] = pd.qcut(df_main['lai'], 5, labels=["verylow", "low", "medium", "high", "veryhigh"])
        df_main["chl_cat_a"] = pd.qcut(df_main['chl'], 3, labels=["low", "medium", "high"])
        df_main["chl_cat_b"] = pd.qcut(df_main['chl'], 5, labels=["verylow", "low", "medium", "high", "veryhigh"])
        ...
        df = df_fin.drop(columns=['index', 'plant_no', 'dua_grp', 'leaf_no']) #no column named level_0
